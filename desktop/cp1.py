...
input()
columns = countv12.name((df.shape[1]+1))
...
chart.add_series({'name':'=prueba!$C$203',
                  'categories':'=prueba!$F$1:$'+columns+'$1',#eje x
                  'values':'=prueba!$F$203:$'+columns+'$203'})#eje y
    #US
chart.add_series({'name':'=prueba!$C$227',
                  'categories':'=prueba!$F$1:$'+columns+'$1',#eje x
                  'values':'=prueba!$F$227:$'+columns+'$227'})#eje y
    #Italy
chart.add_series({'name':'=prueba!$C$139',
                  'categories':'=prueba!$F$1:$'+columns+'$1',#eje x
                  'values':'=prueba!$F$139:$'+columns+'$139'})#eje y
    #Hubei, China
chart.add_series({'name':'=prueba!$B$64',
                  'categories':'=prueba!$F$1:$'+columns+'$1',#eje x
                  'values':'=prueba!$F$64:$'+columns+'$64'})#eje y
# Now add a new worksheet and add chart
#worksheet = workbook.add_worksheet(name='Chart')
#Insert the chart into the worksheet
worksheet.insert_chart('B2',chart)
#Configure the chart axes
chart.set_x_axis({'name':'Time','num_format':'d/m/yy'})
